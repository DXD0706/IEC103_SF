...
public:
	...
	virtual void Start();
	void setPointAddrMap(map<string,string> pointAddrmap);
	bool connectRedis(string ip, int port);
	void writePointsValue(std::vector<Tag>& m_tag_ver);
	void setChannel(vector<string> vecChannel);
